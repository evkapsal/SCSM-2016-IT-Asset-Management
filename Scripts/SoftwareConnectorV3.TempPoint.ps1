				...
				if ($SoftItem)
				{
					try
					{
						if ($iSoftPublisher.Length -gt 0)
						{
							...
							$Publishers = $null
							$Publishers = Get-SCSMObject -Class $ITSMPublisherClass
							foreach ($Publ in $Publishers)
							{
								$k = $Publ.Displayname -match $iSoftPublisher
								if ($k -eq $true)
								{ $PublisherExists = $Publ }
							}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU59pWFCKpcj9delXVmYmU6nU8
# r7Kggg60MIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AYI3AgEEMCMGCSqGSIb3DQEJBDEWBBTc+8rwB1KxtaHjcHlrxXpaw5cyzDANBgkq
# hkiG9w0BAQEFAASCAQA7LnV2KCD+2bQjnOW49T44YDn/WJOV3C5DRKH8ysI8+7wQ
# /GUOi3zc0wfO03e+lGdomn5Zya0EBReOBQ038hsiLk7L6IUi3wjsMtIoUH+ejvXm
# zeg0VHsnDoz67Sl+Ze/SpHvEilUyZGo6kEZ0lKGV5/081ypiOet6rs3IodDnpc95
# 6FpA+iW1G9UdGkeMCr/GvjnxnmHcISpNuudfWNZHKvnljNVX+Xi6KbmnjklFcJUw
# C0xsLHktGNvrQ8L3BeOhboZF2xaexasPUFxCceNUJp9jwQOr3rG8DOU6KUg8o/rD
# ar0ffpfa6okFfYEpOl2+r8AJXTFeFIpeBtUfUpFooYICojCCAp4GCSqGSIb3DQEJ
...
# AzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDgyMDE5MzUzN1owIwYJ
# KoZIhvcNAQkEMRYEFL2k9NMbvBUkMWxuGG7L3N6mv9D7MIGdBgsqhkiG9w0BCRAC
...
# FDANBgkqhkiG9w0BAQEFAASCAQAi/VPSv4JkRJYMgnqC7yWkVjMs6tibUToQvreA
# ZeVowJd/P/73INF8Cw5IAY4h9AT+JTKwMVIituIsIF0RlYrKELj0A9sVsLTRWJfJ
# 10TvSksQ/fHiZQh7EIfMqVa4hwfGZ0TUKDAN5YnpUSqFf8T1VZiV1+96PPTDyjMk
# Brqn/v5WPacKQCdaU2oqt5J4uC2cwERe0fR+RrfGLp3qP7hAxHKNVFZusW7hLDoo
# AE4az3uNlcsnJLJlS9UCZa8eeTbLfWNimSBBIRiGqG/PK6d6TCvI9Iu3VtM6O12S
# Ojgs3gF6G3U8AZDLEVuibJxf73VGgNAXOOGjCXpz/PONqKoD
